...
async function main() {
    ...
    const holders         = ['0x6a1cf24C645DB2e37141Fa12E70Cb67e56b336f3', '0x75B98710D5995AB9992F02492B7568b43133161D'] // Array of token holder addresses
    const stakes          = holders.map(() => 1e18) // Array of token stakes for holders (token has 18 decimals, multiply token amount `* 10^18`)
    const votingSettings  = [50e16, 5e16, 86400] // Array of [supportRequired, minAcceptanceQuorum, voteDuration] to set up the voting app of the organization
    ...
    await Template.newTokenAndInstance(tokenName, tokenSymbol, id, holders, stakes, votingSettings, financePeriod, useAgentAsVault)
